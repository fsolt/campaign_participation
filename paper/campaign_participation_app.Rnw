...
The results for income inequality are weaker than in Figure~1, and the coefficient of income inequality for those with median incomes is no longer statistically significant.  
